...
def eigenvalue(argument):
    ...
    n = eB1 * a_lattice**2 / (2 * hbar)
    n2 = eB2 * a_lattice**2 / (2 * hbar)
    eigenvalues = []
    ...
    for i in range(N):
        for j in range(N):
            ...
            h11 = 0 * (cos(n) * cos(a) * cos(b) - 1j * sin(n) * sin(a) * sin(b)) + 2 * t11 * cos(2 * a) + e2

            h22 = 0 * (cos(n) * cos(a) * cos(b) - 1j * sin(n) * sin(a) * sin(b)) + 2 * t22 * cos(2 * a) + e2
    ...
    for i in range(N):
        for j in range(N):
            ...
            h11 = (0) * (cos(n2) * cos(a) * cos(b) - 1j * sin(n2) * sin(a) * cos(b)) + 2 * t11 * cos(2 * a) + e2
            h22 = (0) * (cos(n2) * cos(a) * cos(b) - 1j * sin(n2) * sin(a) * cos(b)) + 2 * t22 * cos(2 * a) + e2
            h12 = (
