...
\begin{acronym} % Give the longest label here so that the list is nicely aligned
	...
	\acro{EFA}{Envelop Function Approximation}
...
\begin{table}[h]
	\begin{equation*}
		...
		\end{NiceArray}
	\end{equation*}
	\caption[Fitted parameters]{Fitted parameters in three-band NN tight-binding model for \ac{GGA} cases for MX$_{2}$ \cite{PhysRevB.88.085433}.}
\end{table}
