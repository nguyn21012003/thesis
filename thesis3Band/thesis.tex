...
\begin{equation}
	\begin{aligned}
		...
		\begin{pNiceMatrix}
			...
			2t_{0}\cos\gamma_{1} & \epsilon_{1}         & 2t_{0}\cos\zeta_{2} & t_{0}               & 0      & \cdots               & 0                    & t_{0}                \\
			t_{0}               & 2 t_{0}\cos\gamma_{2} & \epsilon_{1}        & 2t_{0}\cos\zeta_{3} & t_{0}  & 0                    & 0                    & 0                    \\
			\vdots              & \vdots               & \vdots              & \vdots              & \vdots & \vdots               & \vdots               & \vdots               \\
			t_{0}               & 0                    & \cdots              & 0                   & t_{0}  & 2t_{0}\cos\gamma_{7} & \epsilon_{1}         & 2t_{0}\cos\zeta_{7}  \\
			2t_{0}\cos\zeta_{8} & t_{0}                & \cdots              & 0                   & 0      & t_{0}                & 2t_{0}\cos\gamma_{8} & \epsilon_{1}         \\
		\end{pNiceMatrix}
	\end{aligned}
\end{equation}
and $h_{0},h_{1},h_{2},h_{11},h_{12},h_{22}$ are sub-matrices have size $q \times q$.\\
\begin{figure*}[htb]
	\centering
	\begin{subfigure}[b]{0.495\textwidth}
		\centering
	...
	\end{subfigure}
	\caption{
		An easy and intuitive visualization of matrix $h_{0}$ one band(left) and matrix $H$ all band(right) through standard plotter with $q = 20$.
	}
\end{figure*}
